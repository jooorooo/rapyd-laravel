...
@section('body')
    ...
    {!! Documenter::showMethod("Simexis\\Rapyd\\Demo\\DemoController", "getEmbed") !!}
    {!! Documenter::showMethod("Simexis\\Rapyd\\Demo\\DemoController", "getNudegrid") !!}
    {!! Documenter::showMethod("Simexis\\Rapyd\\Demo\\DemoController", "anyNudeedit") !!}
