...
use Simexis\Rapyd\Exceptions\DataSetException;
...
class DataSet extends Widget
{
    ...
    public static function source($source)
    {
        ...
        if ($ins->source instanceof \Simexis\Rapyd\DataFilter\DataFilter) {
    ...
    public function build()
    {
        ...
        } elseif ( is_a($this->source, "\Simexis\Rapyd\DataFilter\DataFilter")) {
           $this->type = "model";
